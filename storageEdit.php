					...
					<tr>
						...
						<tr><td>Price</td><td><input type='text' name='Price' /></td></tr>
							...
							if(isset($_POST['editStorage'])){
								...
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$editStorage. "' name=\"editStorage\">Submit</button></td></tr>";
							}
							if(isset($_POST['insertStorage'])){
								$insertStorage = mysql_real_escape_string($_POST['insertStorage']);
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$insertStorage. "' name=\"insertStorage\">Submit</button></td></tr>";
							}
							?>
