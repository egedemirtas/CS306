	...
	<div class="container">
		<div class="col-lg-4">
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
						<form action='thermal.php' method=POST >
							...
							if(isset($_POST['editThermal'])){
								...
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$editThermal. "' name=\"editThermal\">Submit</button></td></tr>";
							}
							if(isset($_POST['insertThermal'])){
								$insertThermal = mysql_real_escape_string($_POST['insertThermal']);
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$insertThermal. "' name=\"insertThermal\">Submit</button></td></tr>";
							}
							?>
