			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<tr>
						...
						<tr><td>Integrated GPU</td><td><input type='text' name='IntegratedGPU' /></td></tr>
						<tr><td>Socket</td><td><input type='text' name='Socket' /></td></tr>
						<tr><td>Core Number</td><td><input type='text' name='CoreNumber' /></td></tr>
						...
						<tr><td>Price</td><td><input type='text' name='Price' /></td></tr>
							...
							if(isset($_POST['editCPU'])){
								...
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$editCPU. "' name=\"editCPU\">Submit</button></td></tr>";
							}
							if(isset($_POST['insertCPU'])){
								$insertCPU = mysql_real_escape_string($_POST['insertCPU']);
								echo "<tr><td colspan=\"8\"><button class=\"btn btn-primary\" type='submit' value= '" .$insertCPU. "' name=\"insertCPU\">Submit</button></td></tr>";
							}
							?>
